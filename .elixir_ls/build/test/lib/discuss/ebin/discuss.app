{application,discuss,
             [{applications,[kernel,stdlib,elixir,logger,runtime_tools,
              ...
              {modules,['Elixir.Discuss','Elixir.Discuss.Application',
                        'Elixir.Discuss.DataCase','Elixir.Discuss.Posts',
                        'Elixir.Discuss.Posts.Comment',
                        'Elixir.Discuss.Posts.Topic',
                        'Elixir.Discuss.Posts.User','Elixir.Discuss.Repo',
                        'Elixir.DiscussWeb',
                        ...
                        'Elixir.Jason.Encoder.Discuss.Posts.Comment',
                        'Elixir.Jason.Encoder.Discuss.Posts.User']},
              {registered,[]},
              {vsn,"0.1.0"},
